...
5. After confirmation, run `scripts/init_world.py --world-id <id> --brief <draft> --confirmed` to create the formal world tree, preserve creation fields plus field source map, and write the first `SAVE.md`.
